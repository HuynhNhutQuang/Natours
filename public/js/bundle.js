...
var login = exports.login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password, next) {
    var res;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'You logged in successfully');
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Loggout Error, try again!');
        case 10:
        case "end":
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHV5bmhuaHV0cXVhbmcxMjMiLCJhIjoiY2xyenM0N2VsMWFvODJrbXd6czVzeHFkZiJ9.nvS5ce5sC1Yk4wPpbg1CZg';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'data' ? 'http://127.0.0.1:3000/api/v1/users/me' : 'http://127.0.0.1:3000/api/v1/users/updateMyPassword';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51OfcuaCDreqXvF9GbRGe7Z6Pb1mqJDfIg4OG3df9QdBqw4f7HvvIksamhiPbhlae5BYMp7cqP3ZcJL0GS1Yf5gAz00w2mnPtEo');
var bookingTour = exports.bookingTour = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://127.0.0.1:3000/booking/checkout-session/".concat(tourId));
        case 3:
  ...
  return function bookingTour(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var sendData = document.querySelector('.form-user-data');
if (sendData) {
  var updatedUser = sendData.addEventListener('submit', function (e) {
    e.preventDefault();
...
var sendPassword = document.querySelector('.form-user-password');
if (sendPassword) {
  var updatePassword = sendPassword.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var text, passwordCurrent, password, passwordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            text = document.querySelector('.sav-pass-btn');
